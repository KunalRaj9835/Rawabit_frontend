...
export default function MonitoringSOCPage() {
    ...
    <main className="text-gray-900" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="bg-white py-24 px-4">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-6 text-gray-600">{t("socOverviewDesc1")}</p>
            <p className="mt-4 text-gray-600">{t("socOverviewDesc2")}</p>
          </div>
      ...
      <section className="bg-gray-50 py-24 px-4">
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-gray-600">
            {t("socUseCasesSubtitle")}
          </p>
        </div>

        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
          <UseCaseCard icon={<Eye />} title={t("socUse1Title")} desc={t("socUse1Desc")} />
          <UseCaseCard icon={<AlertTriangle />} title={t("socUse2Title")} desc={t("socUse2Desc")} />
          <UseCaseCard icon={<Activity />} title={t("socUse3Title")} desc={t("socUse3Desc")} />
        </div>
      </section>
      ...
      <section className="bg-white py-24 px-4">
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-gray-600">
            {t("socProvideSubtitle")}
          </p>
        </div>

        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
          <ProvideCard icon={<Shield />} title={t("socProvide1Title")} desc={t("socProvide1Desc")} />
          <ProvideCard icon={<Settings />} title={t("socProvide2Title")} desc={t("socProvide2Desc")} />
          <ProvideCard icon={<Zap />} title={t("socProvide3Title")} desc={t("socProvide3Desc")} />
        </div>
      </section>
