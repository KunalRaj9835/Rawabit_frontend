      ...
      <div className="max-w-[1400px] mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
          <ProcessCard
            ...
            href="/services/design-consultation/discovery"
            readMore={t("readMore")}
          />
          ...
          <ProcessCard
            ...
            href="/services/design-consultation/strategy"
            readMore={t("readMore")}
          />
          ...
          <ProcessCard
            ...
            href="/services/design-consultation/design"
            readMore={t("readMore")}
          />
          ...
          <ProcessCard
            ...
            href="/services/design-consultation/implementation"
            readMore={t("readMore")}
          />
        </div>
